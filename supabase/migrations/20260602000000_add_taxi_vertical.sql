-- ============================================================
-- 'taxi' è il 5° verticale, aggiunto dopo la creazione dello schema:
-- i vincoli CHECK su vertical non lo includevano → l'insert di un codice
-- (o prodotto) taxi falliva con demo_codes_vertical_check.
-- ============================================================
...
alter table public.demo_codes
  ...
  check (vertical in ('medical', 'auto', 'legal', 'dental', 'taxi'));
